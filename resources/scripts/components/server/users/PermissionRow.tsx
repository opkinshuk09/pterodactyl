...
const Container = styled.label`
    ${tw`flex items-center border border-transparent rounded md:p-2 transition-colors duration-150 ease-in-out`};
    text-transform: none;
    ...
    &:not(.disabled) {
        ...
        &:hover {
            ${tw`bg-zinc-300 border-zinc-500 dark:bg-zinc-800`};
        }
    }
