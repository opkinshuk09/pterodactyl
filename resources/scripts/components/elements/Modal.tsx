...
export const ModalMask = styled.div`
    ${tw`fixed z-[100] overflow-auto flex w-full inset-0`};
        ...
        <Fade in={render} timeout={150} appear={appear || true} unmountOnExit onExited={() => onDismissed()}>
            ...
            >
                <ModalContainer alignTop={top}>
                    ...
                    <div
                        css={tw`bg-zinc-200 dark:bg-zinc-800 p-3 sm:p-4 md:p-6 rounded shadow-md overflow-y-scroll transition-all duration-150`}
                    >
                        {children}
                    </div>
                </ModalContainer>
