...
const ButtonStyle = styled.button<Omit<Props, 'isLoading'>>`
    ...
    ${(props) =>
        ...
        css<Props>`
            ${(props) =>
                !props.isSecondary &&
                tw`bg-customColors-buttonBackground border-customColors-buttonBorder border text-primary-50`};

            &:hover:not(:disabled) {
                ${tw`bg-customColors-buttonHoverBackground border-customColors-buttonHoverBorder`};
            }
        `};
    ...
    ${(props) =>
        ...
        css<Props>`
            ...
            &:hover:not(:disabled) {
                ...
                ${(props) =>
                    props.color === 'primary' &&
                    tw`bg-customColors-buttonHoverBackground border-customColors-buttonHoverBorder text-primary-50`};
