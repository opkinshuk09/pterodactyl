...
export default ({ activity, children }: Props) => {
    ...
    return (
        <div className={'grid grid-cols-10 py-4 bg-gray-800 border border-gray-600 shadow rounded last:mb-0 group'}>
            ...
            <div className={'col-span-10 sm:col-span-9 flex'}>
                <div className={'flex-1 px-4 sm:px-0'}>
                    ...
                    <div className={'mt-1 flex items-center text-sm text-gray-50'}>
                        {activity.ip && (
                            <span>
                                {activity.ip}
