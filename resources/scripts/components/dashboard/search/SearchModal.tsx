...
const ServerResult = styled(Link)`
    ${tw`flex items-center border bg-zinc-300 border-zinc-500 dark:bg-zinc-900 p-4 rounded no-underline transition-all duration-150`};
                            ...
                            {servers.map((server) => (
                                ...
                                >
                                    <div css={tw`flex-1 mr-4`}>
                                        ...
                                        <p css={tw`mt-1 text-xs text-zinc-600 dark:text-zinc-400`}>
                                            {server.allocations
