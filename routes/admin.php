...
/*
|--------------------------------------------------------------------------
| Theme Settings Controller Routes
|--------------------------------------------------------------------------
|
...
Route::get('/theme', [Admin\Settings\ThemeSettingsController::class, 'index'])->name('admin.theme');
Route::patch('/theme', [Admin\Settings\ThemeSettingsController::class, 'update']);
