...
return [
    ...
    */
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://dir.omame.xyz/.themes/Professional-version.json',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the colors of the theme.
    */
    'colors' => [
        'button-background' => env('CUSTOM_COLOR_BUTTON_BG', '#0967D3'),
        'button-hover-background' => env('CUSTOM_COLOR_BUTTON_HOVER_BG', '#2487EB'),
        'button-border' => env('CUSTOM_COLOR_BUTTON_BORDER', '#01337E'),
        'button-hover-border' => env('CUSTOM_COLOR_BUTTON_HOVER_BORDER', '#0345A0'),
    ],
];
